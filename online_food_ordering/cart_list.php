 <!-- Masthead-->
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		<div class="col-md-4" style="text-align: -webkit-center">
			        			<button  onclick="deleteItem(<?php echo $row['cid']?>)" class="rem_cart btn btn-sm btn-outline-danger" data-id="<?php echo $row['cid'] ?>"><i class="fa fa-trash"></i></button>
    ...
    <script>
		...
		function update_qty(qty,id){
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						load_cart()
						window.location="index.php?page=cart_list";
						end_load()
       ...
       function deleteItem(itemId){
		$.post("delete_cart.php", {itemId: itemId}).done(function(){
			window.location="index.php?page=cart_list";
		});
